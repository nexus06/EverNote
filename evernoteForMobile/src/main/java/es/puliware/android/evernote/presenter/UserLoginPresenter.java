...
public class UserLoginPresenter implements MVPLogin.ProvidedLoginPresenterOps, MVPLogin.RequiredPresenterOps {
     ...
     */
    private WeakReference<MVPLogin.RequiredLoginViewOps> mView;

    private UserModel mModelInstance;


    @Override
    public void onCreate(MVPLogin.RequiredLoginViewOps view) {
    ...
    @Override
    public void onConfigurationChange(MVPLogin.RequiredLoginViewOps view) {
    ...
    public MVPLogin.ProvidedLoginModelOps getModel() {
        return (MVPLogin.ProvidedLoginModelOps) mModelInstance;
    }
